...
@Seguro
//Indica que essa classe vai prover a funcionalidade pra @seguro não o contrário
@Provider
...
//pois a prioridade AUTHENTICATION é maior que o do AUTHORIZATION
@Priority(Priorities.AUTHORIZATION)
public class FiltroAutorizacao implements ContainerRequestFilter {
	//O JAX-RS faz a injeção do ResourceInfoque vai ter os informaÃ§Ãµes
	//do método que está sendo verificado 
	@Context
	private ResourceInfo resourceInfo;
	@Override
	public void filter(ContainerRequestContext requestContext) throws IOException {
		// Pega a classe que contem URL requisitada 
		// E extrai os nivel de permissÃ£o dela
		...
		// E extrai os nivel de permissÃ£o dele
		...
		try {
			...
			//Se caso o usuario nÃ£o possui permissao Ã© dado um execption, 
